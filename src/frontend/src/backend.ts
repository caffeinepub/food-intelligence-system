...
import type { ExternalBlob as _ExternalBlob, HistoryRecord as _HistoryRecord, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async analyzeFood(arg0: bigint, arg1: string): Promise<FoodAnalysis> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeFood(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHistory(): Promise<Array<HistoryRecord>> {
        if (this.processError) {
            try {
    ...
    async saveAnalysis(arg0: string, arg1: string, arg2: bigint, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAnalysis(arg0, arg1, arg2, await to_candid_opt_n13(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_HistoryRecord_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _HistoryRecord): Promise<HistoryRecord> {
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_HistoryRecord>): Promise<Array<HistoryRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_HistoryRecord_n9(_uploadFile, _downloadFile, x)));
}
